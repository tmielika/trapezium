...
*/
package com.verizon.bda.appstartup
 ...
 */
object AppStartup extends ApplicationManagerStartup {


  override def init(envMgr: String, configDirMgr: String, persistSchema: String): Unit = {
